...
r_n2o_0 <- rma.mv(yi,vi, data = d02,random= list(~ 1|study_id), method="REML",sparse = TRUE)
...
fwrite(out1.est, "C:/Users/asus/Desktop/paper1/meta-regression/meta_regression_n2o_estimates.csv")
fwrite(out1.sum, "C:/Users/asus/Desktop/paper1/meta-regression/meta_regression_n2o_summary.csv")
...
summary_output <- summary(r_n2o_final)
...
QE <- summary_output$QE %||% r_n2o_final$QE

df_QE <- summary_output$df.QE %||% (r_n2o_final$k - r_n2o_final$p)
...
write.csv(export_table, "C:/Users/asus/Desktop/paper1/meta-regression/r_n2o_try_summary_full.csv", row.names = FALSE)
