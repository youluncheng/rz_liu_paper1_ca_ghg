...
m1 <- rma.mv(yi,vi,
             mods = ~ nt + rt +ri +rot +
               ...
               rt:map_scaled +
               ri:clay_scaled + 
               rot:clay_scaled + rot:map_scaled -1,
             data = d02,
...
dt.new[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.new[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.new[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
dt.s10[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.s10[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.s10[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CO2/scenario_SI0.tif', overwrite = TRUE)
...
dt.s11[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.s11[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.s11[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CO2/scenario_SI1.tif', overwrite = TRUE)
...
dt.s12[, riyes := fifelse(cropintensity == 1,1,0)]

dt.s12[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s12[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.s12[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.s12[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CO2/scenario_SI2.tif', overwrite = TRUE)
...
dt.s13[, rotyes := fifelse(cropintensity == 1,1,0)]

dt.s13[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s13[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.s13[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.s13[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CO2/scenario_SI3.tif', overwrite = TRUE)
...
dt.s4[, `rtyes:map_scaled` := rtyes * map_scaled]
dt.s4[, `riyes:clay_scaled` := riyes * clay_scaled]
dt.s4[, `rotyes:clay_scaled` := rotyes * clay_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CO2/scenario_4.tif', overwrite = TRUE)   
