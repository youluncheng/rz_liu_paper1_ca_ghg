...
m1 <- rma.mv(yi,vi,
             mods = ~rot +nt + ri + rt + 
               ...
               ri:mat_scaled +ri:map_scaled +ri:soc_scaled + 
               nt:clay_scaled + nt:soc_scaled + nt:mat_scaled +nt:map_scaled +
               rot:map_scaled -1,
             data = d02,
...
dt.new[, rotno := fifelse(cropintensity == 1,1,0)]
...
dt.new[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.new[, `riyes:map_scaled` := riyes * map_scaled]
dt.new[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.new[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.new[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.new[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.new[, `ntyes:map_scaled` := ntyes * map_scaled]
...
dt.s10[, rotyes := fifelse(cropintensity == 1,1,0)]

dt.s10[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.s10[, `riyes:map_scaled` := riyes * map_scaled]
dt.s10[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.s10[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.s10[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.s10[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.s10[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s10[, `rotyes:map_scaled` := rotyes * map_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/n2o/scenario_SI0.tif', overwrite = TRUE)
...
dt.s11[, ntyes := fifelse(NOTILL == 1,1,0)]

dt.s11[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.s11[, `riyes:map_scaled` := riyes * map_scaled]
dt.s11[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.s11[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.s11[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.s11[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.s11[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s11[, `rotyes:map_scaled` := rotyes * map_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/n2o/scenario_SI1.tif', overwrite = TRUE)
...
dt.s12[, rtyes := fifelse(NOTILL == 1,1,0)]

dt.s12[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.s12[, `riyes:map_scaled` := riyes * map_scaled]
dt.s12[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.s12[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.s12[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.s12[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.s12[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s12[, `rotyes:map_scaled` := rotyes * map_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/n2o/scenario_SI2.tif', overwrite = TRUE)
...
dt.s13[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.s13[, `riyes:map_scaled` := riyes * map_scaled]
dt.s13[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.s13[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.s13[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.s13[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.s13[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s13[, `rotyes:map_scaled` := rotyes * map_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/n2o/scenario_SI3.tif', overwrite = TRUE)
...
dt.s4[, `riyes:mat_scaled` := riyes * mat_scaled]
dt.s4[, `riyes:map_scaled` := riyes * map_scaled]
dt.s4[, `riyes:soc_scaled` := riyes * soc_scaled]
dt.s4[, `ntyes:clay_scaled` := ntyes * clay_scaled]
dt.s4[, `ntyes:soc_scaled` := ntyes * soc_scaled]
dt.s4[, `ntyes:mat_scaled` := ntyes * mat_scaled]
dt.s4[, `ntyes:map_scaled` := ntyes * map_scaled]
dt.s4[, `rotyes:map_scaled` := rotyes * map_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/n2o/scenario_4.tif', overwrite = TRUE)   
