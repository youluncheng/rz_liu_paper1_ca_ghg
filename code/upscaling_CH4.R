...
dt.new[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
dt.s10[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CH4/scenario_SI0.tif', overwrite = TRUE)
...
dt.s11[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CH4/scenario_SI1.tif', overwrite = TRUE)
...
dt.s12[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CH4/scenario_SI2.tif', overwrite = TRUE)
...
dt.s13[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CH4/scenario_SI3.tif', overwrite = TRUE)
...
dt.s4[, `rotyes:ph_scaled` := rotyes * ph_scaled]
...
# write as output
terra::writeRaster(r.fin,'C:/Users/asus/Desktop/paper1/upscaling/LLdata_for_upscaling/CH4/scenario_4.tif', overwrite = TRUE)   
